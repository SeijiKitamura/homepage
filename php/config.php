...
<ul>
 <li>商品について:</li>
 <li>表示されている商品は参考イメージとなっております。
     季節により内容が変更となる場合がございます。</li>
 <li>ご予約について:</li>
 <li>1個から10個まで：2日前までにご注文ください。</li>
 <li>10個以上：1週間前までにご注文ください。</li>
 <li>キャンセルについて:</li>
 <li>前日午前中まではキャンセルを承ります。
 <li>その他:</li>
 <li>各商品の内容については担当者までご相談ください。</li>
</ul>
EOF;
